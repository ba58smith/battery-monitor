...
#define TEMP_ALARM_EMAIL_THRESHOLD 0 // in MINUTES
...
#define HUMIDITY_ALARM_RANGE_UPPER 65.0F // 50.0 gave too many false alarms
#define HUMIDITY_ALARM_EMAIL_THRESHOLD 0 // in MINUTES
